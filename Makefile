# Makefile for gopy pkg generation of python bindings to poly
# File is generated by gopy (will not be overwritten though)
# gopy pkg github.com/bebop/poly
...
gen:
	gopy pkg -no-make github.com/bebop/poly
